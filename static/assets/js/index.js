...
document.addEventListener("click", (evt) => {
    ...
    const flyoutElementIcon = document.getElementById("flyoutIcon-example");
    let targetElement = evt.target; 

    do {
        if (targetElement == flyoutElement || targetElement == flyoutElementIcon) {
    ...
    document.getElementById("flyout-example").classList.remove('active')
});

document.addEventListener("click", (evt) => {
    const flyoutElement = document.getElementById("flyout-exampl");
    const flyoutElementIcon = document.getElementById("flyoutIcon-exampl");
    let targetElement = evt.target; 

    do {
        if (targetElement == flyoutElement || targetElement == flyoutElementIcon) {
            document.getElementById("flyout-deb").textContent = "";
            return;
        }
    ...
    document.getElementById("flyout-exampl").classList.remove('active')
});

document.addEventListener("click", (evt) => {
    const flyoutElement = document.getElementById("flyout-exa");
    const flyoutElementIcon = document.getElementById("flyoutIcon-exa");
    let targetElement = evt.target; 

    do {
        if (targetElement == flyoutElement || targetElement == flyoutElementIcon) {
            document.getElementById("flyout-d").textContent = "";
            return;
        }
